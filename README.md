...
```shell
yarn add @donnfelker/editor-js-image
```

Include module at your application

```javascript
import ImageTool from '@donnfelker/editor-js-image';
```

Optionally, you can load this tool from [JsDelivr CDN](https://cdn.jsdelivr.net/npm/@donnfelker/editor-js-image@latest)
